package com.example.book_eshop.Admin;
...
import com.example.book_eshop.Model.AdminOrders;
import com.example.book_eshop.R;
...
public class AdminNewOrdersActivity extends AppCompatActivity
{
        ...
        FirebaseRecyclerAdapter<AdminOrders, AdminOrderViewHolder> adapter =
                new FirebaseRecyclerAdapter<AdminOrders, AdminOrderViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull AdminOrderViewHolder holder, int position, @NonNull AdminOrders model)
                    {
                        ...
                        holder.userStock.setText("Stock" +model.getStock());
    ...
    {
        public TextView userName, userPhoneNumber, userTotalPrice, userDataTime, userShippingAddress, userStock;
        ...
        public AdminOrderViewHolder(@NonNull View itemView)
        {
            ...
            userStock= itemView.findViewById(R.id.order_stock);
